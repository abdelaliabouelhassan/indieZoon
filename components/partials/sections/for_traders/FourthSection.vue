<template>
    <section id="home_fourth_section" class="w-full relative pb-20 mt-52 md:mt-20 lg:mt-32 xl:mt-48">
        ...
        <div class="absolute top-0  w-full flex flex-col gap-y-8 px-4 container left-1/2 -translate-x-1/2 ">
            <h2 class="text-4xl font-bold sm:text-5xl md:text-start md:pt-52 lg:pt-20">{{ $t('Unsere_Mission') }}</h2>
            <p class="max-w-sm md:max-w-lg xl:max-w-xl lg:text-lg md:font-semibold">{{ $t('Den_lokalen') }}</p>
            <nuxt-link to="/about">
