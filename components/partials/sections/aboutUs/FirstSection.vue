<template>
    <section class="relative">
        <!--  -->
        <div class="grid grid-cols-1 md:grid-cols-2 md:max-w-[69.375rem] md:mx-auto md:px-4  md:gap-4 lg:gap-8">
            <!--  -->
            <div class="grid grid-cols-2 container mx-auto px-4 md:px-0 gap-4 lg:gap-8"> 
                ...
                <div class="image-element cursor-pointer flex flex-col items-center justify-between relative
                    ...
                    <img class="w-full h-36 xs:h-48 xs:w-48 rounded-lg object-cover 
                                sm:w-56 sm:h-56 md:h-48 md:w-48 lg:w-56 lg:h-56" src="/images/Team/Richard.jpg" alt="Richard">
                    <!-- team member name -->
                    ...
                    <!-- linkden icon -->
                    <svg class="w-6 h-6 absolute top-[60%] right-[10%] xs:right-[20%] xs:top-[65%] xs:w-8 xs:h-8 sm:right-[25%] md:right-[15%] fade-in" 
            ...
            <div class="bg-primary mt-5 col-span-full md:hidden">
                <!-- team member info -->
                <div v-if="infoBar === 'first_img_info'" class="info_bar fade-in bg-primary h-96 p-4 w-full ">
                    <h1 class="text-5xl text-white"> Richard</h1>
                </div>
                <!-- team member info -->
                <div v-if="infoBar === 'second_img_info'" class="info_bar fade-in bg-primary h-96 p-4 w-full">
                    <h1 class="text-5xl text-white"> Klara</h1>
                </div>
            </div>

            <div class="grid grid-cols-2 container mx-auto px-4 mt-10 md:mt-0 md:px-0  gap-4 lg:gap-8"> 
                <!-- team member  -->
                <div class="image-element cursor-pointer flex flex-col items-center justify-between relative"
                    @mouseover="mouseOver($event,'third_img_info') "  @mouseout="mouseOut">
                    <!-- team member image -->
                    <img class="w-full h-36 xs:h-48 xs:w-48 rounded-lg object-cover
                                sm:w-56 sm:h-56 md:h-48 md:w-48 lg:w-56 lg:h-56" src="/images/Team/Benni.jpg" alt="Benni">
                    <!-- team member name -->
                    <span class="font-semibold pt-1 transition-opacity duration-300 ease-in-out"
                ...
                <div class="image-element cursor-pointer flex flex-col items-center justify-between relative"
                    ...
                    <!-- team member image -->
                    <img class="w-full h-36 xs:h-48 xs:w-48 rounded-lg object-cover
                                sm:w-56 sm:h-56 md:h-48 md:w-48 lg:w-56 lg:h-56" src="/images/Team/Michael.jpg" alt="Michael">
                    <!-- team member name -->
                    <span class="font-semibold pt-1 transition-opacity duration-300 ease-in-out"
            ...
            <div class="bg-primary mt-5 col-span-full md:hidden">
                <!-- team member info -->
                <div v-if="infoBar === 'third_img_info'" class="info_bar fade-in bg-primary h-96 p-4 w-full ">
                    <h1 class="text-5xl text-white"> Benni</h1>
                </div>
                <!-- team member info -->
                <div v-if="infoBar === 'fourth_img_info'" class="info_bar fade-in bg-primary h-96 p-4 w-full ">
        ...
        <div class="hidden bg-primary w-full md:block mt-5" >
