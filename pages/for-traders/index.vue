<template>
    <div>
        <PartialsSectionsForTradersHeroSection/>
        <PartialsSectionsForTradersSecondSection/>
        <PartialsSectionsForTradersThirdSection/>
        <PartialsSectionsForTradersFourthSection/>
        <PartialsSectionsForTradersFifthSection/>
        <PartialsSectionsForTradersSixthSection/>
    </div>
</template>
